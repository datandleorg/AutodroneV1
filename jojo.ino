...
void calculate_esc(){
  ...
  throttle = 1400;                                      //We need the throttle signal as a base signal.
  //d_throttle = 1200;
...
void send_esc_signals(){
     analogWrite(FR,map(ESCout_1, 1000, 2000, 0, 255));
     analogWrite(RR,map(ESCout_2, 1000, 2000, 0, 255));
     analogWrite(RL,map(ESCout_3, 1000, 2000, 0, 255));
     analogWrite(FL,map(ESCout_4, 1000, 2000, 0, 255));
